...
public class ComplexStructureDomain {
    ...
    public static HashMap<String, ColumAttribute> ALL_DATA_COLUMNS = new HashMap<String, ColumAttribute>() {
        {
            ...
            put("fld_area_guid", new ColumAttribute("fld_area_guid", true, true, true, true, ""));
            ...
            put("fld_object_guid", new ColumAttribute("fld_object_guid", true, true, true, true, ""));
            put("fld_object_name", new ColumAttribute("fld_object_name", true, true, true, true, ""));
            put("fld_owner_guid", new ColumAttribute("fld_owner_guid", true, true, true, true, ""));
            put("fld_owner_name", new ColumAttribute("fld_owner_name", true, true, true, true, ""));
            put("fld_project_guid", new ColumAttribute("fld_project_guid", true, true, true, true, ""));
            ...
            put("fld_reason_guid", new ColumAttribute("fld_reason_guid", true, true, true, true, ""));
            ...
            put("am_fld_guid", new ColumAttribute("am_fld_guid", false, true, true, true, ""));
            ...
            put("ct_fld_owner_fee_guid", new ColumAttribute("ct_fld_owner_fee_guid", false, true, true, true, ""));
            put("ct_fld_operate_guid", new ColumAttribute("ct_fld_operate_guid", false, true, true, true, ""));
            put("co_fld_guid", new ColumAttribute("co_fld_guid", false, true, true, true, ""));
            ...
            put("fld_name", new ColumAttribute("fld_name", true, true, true, false, ""));
        }
    };
    ...
    public static HashMap<String, ColumAttribute> ES_INFO_OBJECT_COLUMNS = new HashMap<String, ColumAttribute>() {
        {
            ...
            put("fld_class_guid", new ColumAttribute("o_fld_class_guid", true, true, true, true, ""));
    ...
    public static HashMap<String, ColumAttribute> ES_CHARGE_TICKET_PAY_DETAIL_COLUMNS = new HashMap<String, ColumAttribute>() {
        {
            ...
            put("fld_owner_fee_guid", new ColumAttribute("ct_fld_owner_fee_guid", true, false, true, true, null));
            put("fld_operate_guid", new ColumAttribute("ct_fld_operate_guid", true, true, true, true, null));
        }
    };
    ...
    public static HashMap<String, ColumAttribute> ES_COMMERCE_BOND_MAIN = new HashMap<String, ColumAttribute>() {
        {
            ...
            put("fld_area_guid", new ColumAttribute("cbm_fld_area_guid", true, true, true, true, ""));
            put("fld_owner_guid", new ColumAttribute("cbm_fld_owner_guid", true, true, true, true, ""));
    ...
    public static HashMap<String, ColumAttribute> ES_COMMERCE_BOND_FEE_OBJECT = new HashMap<String, ColumAttribute>() {
        {
            ...
            put("fld_object_guid", new ColumAttribute("cbfo_fld_object_guid", true, true, true, true, ""));
            put("fld_bond_guid", new ColumAttribute("cbfo_fld_bond_guid", true, true, true, true, ""));
        }
    };
    ...
    public static HashMap<String, ColumAttribute> ES_INFO_PARAM_INFO = new HashMap<String, ColumAttribute>() {
        {
            put("fld_guid", new ColumAttribute("pi_fld_guid", true, false, true, true, null));
    ...
    public static HashMap<String, HashMap<String, ColumAttribute>> TABLES = new HashMap<String, HashMap<String, ColumAttribute>>() {
        {
            ...
            put(Config.Add1, ES_CHARGE_SETTLE_ACCOUNTS_MAIN_COLUMNS_ADD);
        }
    };
}
